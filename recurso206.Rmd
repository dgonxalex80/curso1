...
knitr::include_graphics("img/matriz4.png")
```
...
Al inicio del dia un empleado revisa todas las solicitudes enviadas a la oficina via email. Si la atención de la solicitud requiere mas de dos minutos las pasa al siguiente nivel. Si por el contrario evalua que se pueden realizar en menos de dos minutos, la gestiona inmediatamente. Organiza las acciones a ejecutar como analisis de prestamos. Evalua las solicitudes realizadas y realiza los procesos establecidos paara el otorgamiento de los creditos. Finalmente realiza la comunicación de las aprobaciones 
...
Se requiere construir una web para un nuevo producto

Debe tener : Programa solido sin errores, seguro y funcional
Debería tener : Rapidez, diseño atractivo, notificaciones por e-mail
Pdría tener : Menú funcional, buzon de sugerencias, sección de blogs
No tendrá : forma de pagos, anuncios
...
```{r, echo=FALSE, out.width="50%", fig.align = "center"}
knitr::include_graphics("img/m135.png")
```

### **Evaluación**

* Al inicio de la jornada laboral utilizas algún método para priorizar las tareas que tienes pendientes?


* Cuál de los métodos descritos se ajusta más a las labores que realizas?
